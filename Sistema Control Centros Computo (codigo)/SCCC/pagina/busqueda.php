...
<td>
 ...
 <P ALIGN=center> <FONT FACE="arial" SIZE=5 COLOR="#00b5e2"> <b> Software insatalados  </b><br> </FONT></DIV>
 <td>&nbsp;</td>
    <td colspan="2"><p>&nbsp;</p>
	 <td>&nbsp;</td>
    <td colspan="2"><p>&nbsp;</p>
	...
	<TR>
	 ...
	 <?php
                        ...
                        $sql = "SELECT * FROM software_instalado WHERE nombre LIKE '%$busqueda%' OR descripcion LIKE '%$busqueda%'";
                     
 $result = mysqli_query($conn, $sql);
  ?>
 <TABLE  ALIGN=left  border="1">
  
      <td width="97" bgcolor="#AED4F0"><div align="center" class="Estilo1">Nombre</div></td>
      <td width="92" bgcolor="#AED4F0"><div align="center" class="Estilo1">Descripcion </div></td>
     <td width="97" bgcolor="#AED4F0"><div align="center" class="Estilo1">No de Equipo</div></td>
