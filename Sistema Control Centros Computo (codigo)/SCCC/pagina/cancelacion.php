						...
						switch($type)
                        {
                            case "Docente":
							    ...
							    if(isset($row))
                                {
                                     ...
                                     echo '<div> <strong> No: </strong> <textarea name="num_prestamo" cols="40" rows="1" >'.$row['num_prestamo'].'</textarea></div>';
                                     echo '<div> <strong> Hora: </strong> <textarea name="hora" cols="40" rows="1" >'.$row['hora'].'</textarea></div>';
									 echo '<div> <strong> Docente: </strong> <textarea name="docente" cols="40" rows="1" >0</textarea></div>';
                                     echo '<div> <strong> Fecha: </strong> <textarea name="fecha_prestamo" cols="40" rows="1" >'.$row['fecha_prestamo'].'</textarea></div>';
                                     echo '<div> <strong> Estado: </strong> <textarea name="estado" cols="40" rows="1" >libre</textarea></div>';
