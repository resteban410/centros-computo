...
<P ALIGN=center> <FONT FACE="arial" SIZE=5 COLOR="#00b5e2"> <b> Verifica datos de Cancelacion </b><br> </FONT></DIV>
        ...
        <div id = "content" align="center">
                <?php
						...
						switch($type)
                        {
                            case "Docente":
                                $id = $_POST['DataID'];
                                $sql = "SELECT * FROM equipo WHERE no_serie = '$id'";
							    ...
							    if(isset($row))
                                {
                                     ...
                                     echo '<div> <strong> No serie: </strong> <textarea name="serie" cols="40" rows="1" >'.$row['no_serie'].'</textarea></div>';
                                     echo '<div> <strong> No equipo: </strong> <textarea name="equipo" cols="40" rows="1" >'.$row['numero_equipo'].'</textarea></div>';
						
                                     echo '<div> <strong> laboratorio: </strong> <textarea name="laboratorio" cols="40" rows="1" >'.$row['laboratorio_clave'].'</textarea></div>';
                    echo '<div> <strong> modelo: </strong> <textarea name="modelo" cols="40" rows="1">'.$row['modelo'].'</textarea></div>';
                                     echo '<div> <strong> marca: </strong> <textarea name="marca" cols="40" rows="1">'.$row['marca'].'</textarea></div>';
