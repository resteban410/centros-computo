...
<P ALIGN=center> <FONT FACE="arial" SIZE=5 COLOR="#00b5e2"> <b>Registro de Docentes  </b><br> </FONT></DIV>

<TABLE  ALIGN=center CELLSPACING=10>
<TD>
      <form method="POST" action="consulta.php">
     <br> <br><br> <p align="center"><strong>BUSCAR:
        </strong>
		  <br>
      

<input type="text" name="busqueda" placeholder="Nombre o Apellido">
</TABLE>
   <p align="center">
