...
<P ALIGN=center> <FONT FACE="arial" SIZE=5 COLOR="#00b5e2"> <b> Borrar este faltante¡¡ </b><br> </FONT></DIV>
        ...
        <div id = "content" align="center">
                <?php
						...
						switch($type)
                        {
                            case "Equipo":
                                $id = $_POST['DataID'];
                                $sql = "SELECT * FROM faltantes WHERE no_falla = '$id'";
							    ...
							    if(isset($row))
                                {
                                     ...
                                     echo '<input type="hidden" name="type" value="Equipo">';
                                     echo '<input type="hidden" name="ID" value="'.$id.'">';
									 echo '<div> <strong> Falla: </strong> <textarea name="no_falla" cols="40" rows="1" >'.$row['no_falla'].'</textarea></div>';
                                     echo '<div> <strong> Equipo: </strong> <textarea name="no_equipo" cols="40" rows="1" >'.$row['no_equipo'].'</textarea></div>';
                                     echo '<div> <strong> Laboratorio: </strong> <textarea name="no_laboratorio" cols="40" rows="1" >'.$row['no_laboratorio'].'</textarea></div>';
							
                                     echo '<div> <strong> Observaciones: </strong> <textarea name="observaciones" cols="40" rows="1">'.$row['observaciones'].'</textarea></div>';
...
//////////////////////////////////////////////////////////////////////////////////////////////////////				
 ...
 <td width="90">&nbsp;</td>
    <td width="50"><form id="form2" name="form2" method="post" action="">
      <p align="center"><a href="cons_faltantes.php"><img src="iconos/1.PNG" width="50" height="51" border="0" /></a> </p>
