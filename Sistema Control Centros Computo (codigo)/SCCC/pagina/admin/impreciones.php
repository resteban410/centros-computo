...
<td>
 ...
 <P ALIGN=center> <FONT FACE="arial" SIZE=5 COLOR="#00b5e2"> <b> Servicio de Impresiones </b><br> </FONT></DIV>
 <td>&nbsp;</td>
    <td colspan="2"><p>&nbsp;</p>
	 <td>&nbsp;</td>
    <td colspan="2"><p>&nbsp;</p>
...
<TD>
      <form  ALIGN=left id="form1" name="form1" method="POST" action="imprebd.php">
 ...
 <input type="radio" name="1" value="1" checked>Robotica
  ...
  <input type="radio" name="1" value="3"> Diseño<br><br>
		  ...
		  <p align="center"><strong>Total de impreciones: 	
      <input type="number" name="impre" placeholder="costo por imprecion $1" required/></br>
