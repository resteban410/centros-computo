                         ...
                         $di = $_SESSION['id'];
                        {
                            case "Docente":
							    ...
							    if(isset($row))
                                {
                                     ...
                                     echo '<div> <strong> No: </strong> <textarea name="num_prestamo" cols="40" rows="1" >'.$row['no_serie'].'</textarea></div>';
                                     echo '<div> <strong> Hora: </strong> <textarea name="hora" cols="40" rows="1" >'.$row['laboratorio_clave'].'</textarea></div>';
							
						
                                     echo '<div> <strong> Fecha: </strong> <textarea name="fecha_prestamo" cols="40" rows="1" >'.$row['marca'].'</textarea></div>';

                                     echo '<div> <strong> Laboratorio: </strong> <textarea name="laboratorio_clave" cols="40" rows="1">'.$row['modelo'].'</textarea></div>';
