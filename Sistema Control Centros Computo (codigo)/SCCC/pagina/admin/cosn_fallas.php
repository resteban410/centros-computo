...
<P ALIGN=center> <FONT FACE="arial" SIZE=5 COLOR="#00b5e2"> <b> Control de Fallas  </b><br> </FONT></DIV>
 ...
 <table width="620" height="60" align="center" border="1">
    <tr>      
      ...
      <td width="92" bgcolor="#AED4F0"><div align="center" class="Estilo1">Fecha de Reporte:</div></td>
      <td width="92" bgcolor="#AED4F0"><div align="center" class="Estilo1">Fecha de Atencion:</div></td>

      <td width="93" bgcolor="#AED4F0"><div align="center" class="Estilo1">Diagnostico:</div></td>
      <td width="80" bgcolor="#AED4F0"><div align="center" class="Estilo1">No de Equipo</div></td> 
	   <td width="80" bgcolor="#AED4F0"><div align="center" class="Estilo1">Laboratorio</div></td> 
      <td width="80" bgcolor="#AED4F0"><div align="center" class="Estilo1">Editar</td>  	  
...
<?php						
                        ...
                        {      
                                ...
                                echo '<a>';
                                    ...
                                    echo "<p> <td>".$row['fecha_de_reporte']." </td></p>";
                                    echo "<p> <td> ".$row['fecha_de_atencion']."</td> </p>";
                                    echo "<p> <td>".$row['descripcion']." </td> </p>";
									 echo "<p> <td>".$row['equipo_no_serie']." </td> </p>";
									 echo "<p> <td>".$row['nombre_laboratorio']." </td> </p>";
                                    echo '  <form method = "post" action="editfallas.php" enctype="multipart/form-data">';
                                    echo ' <input type="hidden" name="type" value="Docente"> </td>';
                                    echo ' <input type="hidden" name="DataID" value="'.$row['numero_de_fallas'].'">';
