...
<P ALIGN=center> <FONT FACE="arial" SIZE=5 COLOR="#00b5e2"> <b> Control de Faltantes </b><br> </FONT></DIV>
 ...
 <table width="620" height="60" align="center" border="1">
    <tr>      
      ...
      <td width="92" bgcolor="#AED4F0"><div align="center" class="Estilo1">	Equipo:</div></td>
      <td width="92" bgcolor="#AED4F0"><div align="center" class="Estilo1">Laboratorio:</div></td>

      <td width="93" bgcolor="#AED4F0"><div align="center" class="Estilo1">Fecha:</div></td>
      <td width="80" bgcolor="#AED4F0"><div align="center" class="Estilo1">Hora:</div></td> 
	   <td width="80" bgcolor="#AED4F0"><div align="center" class="Estilo1">Observaciones:</div></td> 
      <td width="80" bgcolor="#AED4F0"><div align="center" class="Estilo1">Eliminar:</td>  	  
...
<?php						
                        ...
                        {      
                                ...
                                echo '<a>';
                                    ...
                                    echo "<p> <td>".$row['no_equipo']." </td></p>";
                                    echo "<p> <td> ".$row['no_laboratorio']."</td> </p>";
                                    echo "<p> <td>".$row['fecha_perdida']." </td> </p>";
									 echo "<p> <td>".$row['hora']." </td> </p>";
									 echo "<p> <td>".$row['observaciones']." </td> </p>";
                                    echo '  <form method = "post" action="editfaltante.php" enctype="multipart/form-data">';
                                    echo ' <input type="hidden" name="type" value="Equipo"> </td>';
                                    echo ' <input type="hidden" name="DataID" value="'.$row['no_falla'].'">';
