...
<P ALIGN=center> <FONT FACE="arial" SIZE=5 COLOR="#00b5e2"> <b> Inventario </b><br> </FONT></DIV>
 ...
 <table width="620" height="60" align="center" border="1">
    <tr>      
      ...
      <td width="92" bgcolor="#AED4F0"><div align="center" class="Estilo1">No serie: </div></td>
      <td width="92" bgcolor="#AED4F0"><div align="center" class="Estilo1">Laboratorio:</div></td>

      <td width="80" bgcolor="#AED4F0"><div align="center" class="Estilo1">Marca: </div></td> 
      <td width="80" bgcolor="#AED4F0"><div align="center" class="Estilo1">Modelo:</td>
...
<?php						
                        ...
                        {      
                                ...
                                echo '<a>';
                                    ...
                                    echo "<p> <td>".$row['no_serie']." </td></p>";
                                    echo "<p> <td> ".$row['laboratorio_clave']."</td> </p>";
									 echo "<p> <td>".$row['marca']." </td> </p>";
									 	 echo "<p> <td>".$row['modelo']." </td> </p>";
                                    echo '  <form method = "post" action="cancelacion.php" enctype="multipart/form-data">';
                                    echo ' <input type="hidden" name="type" value="Docente"> </td>';
                                    echo ' <input type="hidden" name="DataID" value="'.$row['no_serie'].'">';
...
<table width="800" height="1"  border="0" cellspacing="0" cellpadding="0" > 
          ...
          <p align="center"><a href="alta_equipo.php"style=""> <img src="iconos/agre.png"  title="altahorario" width="50" height="51" border="0" />Agregar equipo</a></p>
