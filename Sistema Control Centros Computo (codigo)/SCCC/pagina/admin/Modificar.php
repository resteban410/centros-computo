...
<P ALIGN=center> <FONT FACE="arial" SIZE=5 COLOR="#00b5e2"> <b> Verifica datos de Actualizacion </b><br> </FONT></DIV>
						...
						switch($type)
                        {
                            case "Docente":
							    ...
							    if(isset($row))
                                {
                                     ...
                                     echo '<div> <strong> ID: </strong> <textarea name="clave" cols="40" rows="1" >'.$row['clave'].'</textarea></div>';
                                     echo '<div> <strong> Contraseña: </strong> <textarea name="password" cols="40" rows="1" >'.$row['password'].'</textarea></div>';
						             echo '<div> <strong> Nombre: </strong> <textarea name="nombre" cols="40" rows="1" >'.$row['nombre'].'</textarea></div>';
						             echo '<div> <strong> Apellido: </strong> <textarea name="apellidos" cols="40" rows="1" >'.$row['apellidos'].'</textarea></div>';
					                 echo '<div> <strong> Telefono: </strong> <textarea name="telefono" cols="40" rows="1" >'.$row['telefono'].'</textarea></div>';
                                     echo '<div> <strong> Direccion: </strong> <textarea name="direccion" cols="40" rows="1" >'.$row['direccion'].'</textarea></div>';
						             echo '<div> <strong> Correo: </strong> <textarea name="correo_electronico" cols="40" rows="1" >'.$row['correo_electronico'].'</textarea></div>';
