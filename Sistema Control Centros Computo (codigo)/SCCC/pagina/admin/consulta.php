...
<TD  bgcolor="#003b5c">
   ...
   <?php error_reporting (0);?>
	 ...
	 <?php
                        ...
                        $sql = "SELECT * FROM docente WHERE nombre LIKE '%$busqueda%' OR apellidos LIKE '%$busqueda%'";
                     
 $result = mysqli_query($conn, $sql);
  ?>
 <TABLE  ALIGN=center  border="1">
  
      <td width="97" bgcolor="#AED4F0"><div align="center" class="Estilo1">Clave:</div></td>
	        <td width="97" bgcolor="#AED4F0"><div align="center" class="Estilo1">Contraseña:</div></td>
     ...
     <td width="97" bgcolor="#AED4F0"><div align="center" class="Estilo1">Apellido:</div></td>
	       <td width="92" bgcolor="#AED4F0"><div align="center" class="Estilo1">Telefono:</div></td>
		         <td width="92" bgcolor="#AED4F0"><div align="center" class="Estilo1">Direccion: </div></td>
      <td width="92" bgcolor="#AED4F0"><div align="center" class="Estilo1">Correo: </div></td>
	     <td width="92" bgcolor="#AED4F0"><div align="center" class="Estilo1">Actualizar: </div></td>  
...
<?php						
                        ...
                        {      
                                ...
                                echo "<tr> ";
                                echo '<a>';
                                    echo "<p> <center><td>".$row['clave']."</td></p>";
                                    echo "<p> <td>".$row['password']." </td></p>";
									echo "<p> <td>".$row['nombre']."</td></p>";
                                    echo "<p> <td>".$row['apellidos']." </td></p>";
									   echo "<p> <td>".$row['telefono']." </td></p>";
									   	   echo "<p> <td>".$row['direccion']." </td></p>";
										   	   echo "<p> <td>".$row['correo_electronico']." </td></p>";
                                   echo '  <form method = "post" action="Modificar.php" enctype="multipart/form-data">';
                                    echo ' <input type="hidden" name="type" value="Docente"> </td>';
                                    echo ' <input type="hidden" name="DataID" value="'.$row['clave'].'">';
                                    echo '<td> <button>Actualizar:</button> </td>';
                                           echo "</form>";
                                    echo '  <form method = "POST" action="Eliminar.php" enctype="multipart/form-data">';
                                    echo ' <input type="hidden" name="type" value="Docente"> </td>';
                                    echo ' <input type="hidden" name="DataID" value="'.$row['clave'].'">';
...
<table width="800" height="1"  border="0" cellspacing="0" cellpadding="0" > 
          ...
          <p align="center"><a href="alta.php"style=""> <img src="iconos/cliente.png"  title="altahorario" width="50" height="51" border="0" />Nuevo docente</a></p>
