        ...
        <div id = "content" align="center">
                <?php
						...
						switch($type)
                        {
                            case "Docente":
                                $id = $_POST['DataID'];
                                $sql = "SELECT * FROM software_instalado WHERE clave_software = '$id' ";
							    ...
							    if(isset($row))
                                {
                                     ...
                                     echo '<input type="hidden" name="type" value="Software">';
                                     echo '<input type="hidden" name="ID" value="'.$id.'">';
                                     echo '<div> <strong> Clave producto: </strong> <textarea name="clave" cols="40" rows="1" >'.$row['clave_software'].'</textarea></div>';
                                     echo '<div> <strong> Nombre: </strong> <textarea name="nombre" cols="40" rows="1" >'.$row['nombre'].'</textarea></div>';
						
                                     echo '<div> <strong> Descripcion: </strong> <textarea name="descricion" cols="40" rows="1" >'.$row['descripcion'].'</textarea></div>';
