						...
						switch($type)
                        {
                            case "Docente":
							    ...
							    if(isset($row))
                                {
                                     ...
                                     echo '<div> <strong> Matricula: </strong> <textarea name="matricula" cols="40" rows="1" >'.$row['matricula'].'</textarea></div>';
                                     echo '<div> <strong> Nombre: </strong> <textarea name="nombre" cols="40" rows="1" >'.$row['nombre'].'</textarea></div>';
						
                                     echo '<div> <strong> Apellido: </strong> <textarea name="apellido" cols="40" rows="1" >'.$row['apellido'].'</textarea></div>';
...
//////////////////////////////////////////////////////////////////////////////////////////////////////				
 ...
 <td width="90">&nbsp;</td>
    <td width="50"><form id="form2" name="form2" method="post" action="">
      <p align="center"><a href="modalumno.php"><img src="iconos/1.PNG" width="50" height="51" border="0" /></a> </p>
