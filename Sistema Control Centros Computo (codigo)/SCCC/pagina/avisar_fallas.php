...
<td>
 ...
 <P ALIGN=center> <FONT FACE="arial" SIZE=5 COLOR="#00b5e2"> <b> Reportar Alg&uacute;na Falla de Equipos</b><br> </FONT></DIV>
 <td>&nbsp;</td>
    <td colspan="2"><p>&nbsp;</p>
	 <td>&nbsp;</td>
    <td colspan="2"><p>&nbsp;</p>
...
<TABLE  ALIGN=left CELLSPACING=10>
<TD>
      <form  ALIGN=center id="form1" name="form1" method="POST" action="fallas.php">
...
?> 	
   ...
   <p  align="right"><strong>Descripci&oacute;n de falla:
