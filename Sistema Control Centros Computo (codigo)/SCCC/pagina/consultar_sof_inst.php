...
<td>
 ...
 <P ALIGN=center> <FONT FACE="arial" SIZE=5 COLOR="#00b5e2"> <b> Consulta software instalado </b><br> </FONT></DIV>
 <td>&nbsp;</td>
    <td colspan="2"><p>&nbsp;</p>
	 <td>&nbsp;</td>
    <td colspan="2"><p>&nbsp;</p>
	<TR>
		...
		<TD width="150" height="80" ALIGN=center bgcolor="#00b5e2" > <FONT FACE="Arial " SIZE=5><A HREF="pr.php"  TARGET="_new"  style="color:#FFFFFF;"  style="text-decoration:none" > Solicitar pr&eacute;stamo </TD> 
	
	  
  
		<TD width="150" height="80" ALIGN=center bgcolor="#00b5e2" > <FONT FACE="Arial " SIZE=5><A HREF="scrip_cancelarpres.php"  TARGET="_new"  style="color:#FFFFFF;"  style="text-decoration:none" > Cancelar pr&eacute;stamo  </TD> 
...
<TD>
     ...
     <br> <br><br> <p align="center"><strong>Ingresa el nombre del software :
        </strong>
		  <br>
      

<input type="text" name="busqueda" placeholder="ejemplo: c++">
