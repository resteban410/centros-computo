...
<body>
  ...
  <!-- Fin del header -->
    ...
    <div class="breadcrumb-area bg-img bg-overlay jarallax" style="background-image: url(img/bg-img/65.png);">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcrumb-content text-center">
                        <h2 class="page-title">Preguntas preguntas</h2>
    ...
    <div class="container-fluid">
        ...
        <div class="panel">
            <p>Dentro de este espacio se colocara el texto descriptivo de cada pregunta
            Dentro de este espacio se colocara el texto descriptivo de cada preguntas
