  ...
  <div class="modal-dialog">
    ...
    <form action="{{route('altaEqui')}}" method="post">
      <div class="modal-body">       
            ...
            <div class="form-group">
                <label>Marca:</label>
                    <input type="text" name="marca" class= "form-control" placeholder="Escriba la marca del equipo"> 
  ...
  <div class="modal-dialog">
    ...
    <form action="{{route('editarEqui')}}" method="post" id="editForm">
      <div class="modal-body">       
            ...
            <div class="form-group">
                <label>Marca:</label>
                    <input type="text" name="marca" id="marca" class= "form-control" placeholder="Escriba la marca del equipo"> 
                    {!! $errors->first('marca', '<small>:message</small><br>') !!}
            </div>
            <div class="form-group">
                <label>Modelo:</label>
